...
<%
    ArrayList<Juegos> listaComprados = (ArrayList<Juegos>) request.getAttribute("lista3");
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<%=request.getContextPath()%>/JuegosServlet?a=perfil&id=<%=c.getIdCuentas()%> <% } %>">
                    ...
                    <div class="disponibleUsuario">
                        ...
                        <div class="card mb-10" style="max-width: 1000px;">
                            <div class="row g-0 rounded-4 border border-primary border-2 p-2">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h6 class="card-title"> <%= j.getNombre()%> </h6>
                                        <p class="card-text"> Descripcion : <%=j.getDescripcion()%></p>
                ...
                <div class="row g-0">
                    <div class="col-md-12 bg-primary border rounded-4 p-4">
                        <div class="text-light text-center">
                            <h4>Genero_mas_comprado</h4>
                        </div>

                        <img src="img/usuario/liston.png" width="100%" alt="">
